...
def add_image_to_canvas(numrow_txt,backgroundcolor=[0,0,0], inputpath="cleared_imgs/macaron.png",outputpath="canvas/canvas.png"):#main part of this file
    numrow = numrow_txt
...
def main():
    canvasobj,placed_left,limits,filled_img_w = add_image_to_canvas()
    return canvasobj,placed_left,limits,filled_img_w
